...
#ARGUMENTS: ruby create_suggestion_seed_list.rb <number> outfile
...
File.open("seed_list_unsorted.tmp", "w+") do |outfile|
  ...
  User.where("treatment='test'").each do |u|
    begin
